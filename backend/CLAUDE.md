...
│   │           ├── community/         # Community tools (tavily, jina_ai, firecrawl, image_search, bitget, mt5, deriv, aio_sandbox)
...
- `mt5/` - MetaTrader 5 trading integration (account info, positions, trade execution, history analysis, risk calculator; Windows only)
- `deriv/` - Deriv WebSocket API trading integration (works on any OS; balance, portfolio, trade execution, profit history)
